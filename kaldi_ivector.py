...
class kaldi_ivector:
    ...
    def gen_feats_file(self, data_feats,ids,feat_filename):
        """
    ...
    def train(self, feat_file,model_dir,M,ivector_dim=None,num_gselect=None):
        """
        ...
        os.system(self.PATH+"/train_ivector_models.sh "+str(M) +" "+ str(ivector_dim) + " " + str(num_gselect) + " " + feat_file + " " + model_dir)
        return num_gselect

    def extract(self, src_dir,feat_file,ivectors_dir,num_gselect):
        """
        ...
        Inputs:
            ...
            feat_file: Path to the Kaldi script (.spc) file with the features to use for i-vector extraction
        ...
        os.system(self.PATH+"/extract_ivectors.sh "+str(num_gselect)+ " " + src_dir + " " + feat_file + " " + ivectors_dir)
        keys=[]
    ...
    def ivector_sbjs(self, ivectors,keys,ids):
        """
